...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.xconv1 = GatedConv2D(ch, ch, 5,1)
        self.xconv2_downsample = GatedConv2D(ch, ch, 3, 2)
        self.xconv3 = GatedConv2D(ch, 2 * ch)
        self.xconv4_downsample = GatedConv2D(2 * ch, 2 * ch, 3, 2)
        ...
        #attention branch
        self.pmconv1 = GatedConv2D(ch, ch, 5, 1)
        self.pmconv2_downsample = GatedConv2D(ch, ch, 5, 1)
        self.pmconv3 = GatedConv2D(ch, ch, 5, 1)
        self.pmconv4_downsample = GatedConv2D(ch, ch, 5, 1)
        self.pmconv5 = GatedConv2D(ch, ch, 5, 1)
        self.pmconv6 = GatedConv2D(ch, ch, 5, 1)
        #TODO: contectual attention
        self.pmconv9 = GatedConv2D(ch, ch, 5, 1)
        self.pmconv10 = GatedConv2D(ch, ch, 5, 1)
        #pm = x
        ...
        self.allconv16 = GatedConv2D(ch, ch // 2, 3, 1)
        self.allconv17 = GatedConv2D(ch // 2, 3, 3, 1)
